...
/* ============================================================
   ...
   Theme: bg-theme-dark-sidebar, canvas-bg, card-bg etc.
   ============================================================ */
:root {
...
/* ---- Input Fields: Rounded + Warm Focus ---- */
input[type="text"],
input[type="email"],
input[type="number"],
input[type="date"],
...
/* ---- Global header: match warm canvas ---- */
.global-header {
...
print("Warm Minimalist tokens appended to style.css")
